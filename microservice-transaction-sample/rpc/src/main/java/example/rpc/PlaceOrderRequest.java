...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              itemOrder_ = new java.util.ArrayList<example.rpc.ItemOrder>();
              mutable_bitField0_ |= 0x00000001;
            }
            itemOrder_.add(
                input.readMessage(example.rpc.ItemOrder.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return example.rpc.Example.internal_static_rpc_PlaceOrderRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return example.rpc.Example.internal_static_rpc_PlaceOrderRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            example.rpc.PlaceOrderRequest.class, example.rpc.PlaceOrderRequest.Builder.class);
  }
  ...
  private java.util.List<example.rpc.ItemOrder> itemOrder_;
  /**
   * <code>repeated .rpc.ItemOrder item_order = 2;</code>
   */
  @java.lang.Override
  public java.util.List<example.rpc.ItemOrder> getItemOrderList() {
    return itemOrder_;
  }
  /**
   * <code>repeated .rpc.ItemOrder item_order = 2;</code>
   */
  @java.lang.Override
  public java.util.List<? extends example.rpc.ItemOrderOrBuilder> 
   ...
   */
  @java.lang.Override
  public example.rpc.ItemOrder getItemOrder(int index) {
   ...
   */
  @java.lang.Override
  public example.rpc.ItemOrderOrBuilder getItemOrderOrBuilder(
      int index) {
    return itemOrder_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof example.rpc.PlaceOrderRequest)) {
      return super.equals(obj);
    }
    example.rpc.PlaceOrderRequest other = (example.rpc.PlaceOrderRequest) obj;
  ...
  public static example.rpc.PlaceOrderRequest parseFrom(
  ...
  public static example.rpc.PlaceOrderRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static example.rpc.PlaceOrderRequest parseFrom(
  ...
  public static example.rpc.PlaceOrderRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static example.rpc.PlaceOrderRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static example.rpc.PlaceOrderRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(example.rpc.PlaceOrderRequest prototype) {
  ...
  public static final class Builder extends
      ...
      example.rpc.PlaceOrderRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return example.rpc.Example.internal_static_rpc_PlaceOrderRequest_descriptor;
    }
    ...
    // Construct using example.rpc.PlaceOrderRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public example.rpc.PlaceOrderRequest getDefaultInstanceForType() {
      return example.rpc.PlaceOrderRequest.getDefaultInstance();
    }

    @java.lang.Override
    public example.rpc.PlaceOrderRequest build() {
      example.rpc.PlaceOrderRequest result = buildPartial();
    ...
    @java.lang.Override
    public example.rpc.PlaceOrderRequest buildPartial() {
      example.rpc.PlaceOrderRequest result = new example.rpc.PlaceOrderRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof example.rpc.PlaceOrderRequest) {
        return mergeFrom((example.rpc.PlaceOrderRequest)other);
      } else {
    ...
    public Builder mergeFrom(example.rpc.PlaceOrderRequest other) {
      if (other == example.rpc.PlaceOrderRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      example.rpc.PlaceOrderRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (example.rpc.PlaceOrderRequest) e.getUnfinishedMessage();
    ...
    private void ensureItemOrderIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        itemOrder_ = new java.util.ArrayList<example.rpc.ItemOrder>(itemOrder_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        example.rpc.ItemOrder, example.rpc.ItemOrder.Builder, example.rpc.ItemOrderOrBuilder> itemOrderBuilder_;
    ...
    public Builder setItemOrder(
        int index, example.rpc.ItemOrder value) {
      if (itemOrderBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setItemOrder(
        int index, example.rpc.ItemOrder.Builder builderForValue) {
      if (itemOrderBuilder_ == null) {
        ensureItemOrderIsMutable();
     ...
     * <code>repeated .rpc.ItemOrder item_order = 2;</code>
     */
    public Builder addItemOrder(example.rpc.ItemOrder value) {
      if (itemOrderBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addItemOrder(
        example.rpc.ItemOrder.Builder builderForValue) {
      if (itemOrderBuilder_ == null) {
        ensureItemOrderIsMutable();
    ...
    public Builder addAllItemOrder(
        java.lang.Iterable<? extends example.rpc.ItemOrder> values) {
      if (itemOrderBuilder_ == null) {
        ensureItemOrderIsMutable();
     ...
     * <code>repeated .rpc.ItemOrder item_order = 2;</code>
     */
    public example.rpc.ItemOrder.Builder getItemOrderBuilder(
        int index) {
     ...
     * <code>repeated .rpc.ItemOrder item_order = 2;</code>
     */
    public example.rpc.ItemOrder.Builder addItemOrderBuilder() {
      return getItemOrderFieldBuilder().addBuilder(
          example.rpc.ItemOrder.getDefaultInstance());
    }
    /**
     * <code>repeated .rpc.ItemOrder item_order = 2;</code>
     */
    public example.rpc.ItemOrder.Builder addItemOrderBuilder(
        int index) {
      return getItemOrderFieldBuilder().addBuilder(
          index, example.rpc.ItemOrder.getDefaultInstance());
    }
    /**
     * <code>repeated .rpc.ItemOrder item_order = 2;</code>
     */
    public java.util.List<example.rpc.ItemOrder.Builder> 
         getItemOrderBuilderList() {
      return getItemOrderFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        example.rpc.ItemOrder, example.rpc.ItemOrder.Builder, example.rpc.ItemOrderOrBuilder> 
        getItemOrderFieldBuilder() {
      if (itemOrderBuilder_ == null) {
  ...
  private static final example.rpc.PlaceOrderRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new example.rpc.PlaceOrderRequest();
  }

  public static example.rpc.PlaceOrderRequest getDefaultInstance() {
